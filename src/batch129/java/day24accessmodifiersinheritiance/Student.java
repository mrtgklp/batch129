...
*/
    ...
    //Protected olanlar baska package dan sadece child class'lardan görülür
    protected String adress = "Istanbul";
    //default olanlar baska package ' den
    //Kullanılamazlar isyeri mail'i
    String email = "abcan@gmail.com";
    //private olanlar sadece oluşturduk
    //Class içinde kullanılabilirler TC NO
    private String tcNo = "112345678911";

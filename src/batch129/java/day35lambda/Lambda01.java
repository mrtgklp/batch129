package batch129.java.day35lambda;
...
//get()==> methodu optional data type'ini Integer'a cevirir.
    ...
    public static void main(String[] args) {
        ...
        System.out.println();
        printCubeOfDistrictOddElements(nums);//729 2248091 3375
        System.out.println();
    ...
    //1)Create a method to print the list elements on the console in the same line with a space between two consecutive elements.(Structuree)
    //1)Bir listte ki elemanları aynı satırda aralarına bosluk koyarak yazdıran method u oluşturunuz(Structured)
    ...
    //2)Create a method to print the list elements on the console in the same line with a space between two consecutive elements.(Structuree)
    //2)Bir listte ki elemanları aynı satırda aralarına bosluk koyarak yazdıran method u oluşturunuz(Structured)
    ...
    //Bir list teki cift elemanları aynı satırda aralarina bosluk koyarak yazdıran method u olusturunuz.(Structured)
    ...
    //Bir list teki cift elemanları aynı satırda aralarina bosluk koyarak yazdıran method u olusturunuz.(Functional)
    ...
    //Bir listeki tek sayı olan elemanlarını karelerini aynı satırda aralarına bosluk koyarak yazdıran method u olusturunuz.(Functional)
    ...
    public static void printCubeOfDistrictOddElements(List<Integer> nums){
        nums.
                stream().distinct().//distinct() method u bu şekilde sıraya koymak daha hızlı çalıştırır methodu
                filter(t->t%2!=0).
                //distinct().
                map(t->t*t*t).
                forEach(t-> System.out.print(t + " "));
   ...
   //1.Yol
    public  static  void getMaxValue(List<Integer> nums){
       //Maximun degeri araken Integer.MIN_VALUE kullanmak genel pratiktir
       //Mininum degeri araken Integer.MAX_VALUE kullanmak genel pratiktir
        Integer maxValue = nums.stream().distinct().reduce(Integer.MIN_VALUE,(t,u)->t>u ? t : u);
        System.out.println(maxValue);
    }
    //2.Yol
    public  static  void getMaxValue2(List<Integer> nums){
        Integer maxValue = nums.stream().distinct().reduce(nums.get(0),(t,u)->t>u ? t : u);
        System.out.println(maxValue);
    }
    //3.Yol
    ...
    public  static void getMininumValue(List<Integer> nums){

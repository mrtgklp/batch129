...
public class StringBuilderKıyas {
    /*
    ...
    public static void main(String[] args) {
        ...
        if (stringBuilderSure<stringSure){
            System.out.println("String Builder Daha yavas calısıyor");
        } else if (stringBuilderSure>stringSure) {
            System.out.println("String daha yavas calısıyor");
        }
        else {
            System.out.println("Her ikiside aynı esit surede calıstı");
        }
    }
}
